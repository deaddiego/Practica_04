...
<h1>Consulta de niveles de idiomas</h1>
<div class = "container">
    <div class = "row">
        <table class="table table-bordered">
            ...
            <?php
            foreach ($Idiom_level as $Idiom_level ) {
                ?>
                <tbody>
                <tr>
                    <td> <?php echo $Idiom_level->id ?></td>
                    <td><?php echo $Idiom_level->idiom_id ?></td>
                    <td><?php echo $Idiom_level->level ?></td>
